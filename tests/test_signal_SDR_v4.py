...
symbol_ofdm = 100009.7 + 100009.7j
RS = 8
Nz = 14
...
if CON == 1:
    ...
    Nc = N_qam
    #xt2 = data_qpsk
    ofdm_argv = sample.OFDM_modulator(data_qpsk, Nb, N_interval, symbol_ofdm, RS, Nz)
    ofdm_tx = ofdm_argv[0]
    ...
    if IF_SDR:
        ...
        ofdm_rx = sdr2.rx()
        filename_input = "input_qpsk.txt"
        np.savetxt(filename_input, ofdm_rx, delimiter=":")
    else:
        ofdm_rx = ofdm_tx
    if IF_SDR:
        sdr.tx_destroy_buffer()

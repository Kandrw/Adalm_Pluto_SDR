...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 13 17:32:53 2023
...
#plt.figure(3)
plt.subplot(2, 2, 3)
plt.plot(K, np.abs(np.fft.fftshift(xf1)), "g")
...
Kp2 = 0#.05 # коэффициент пропорциональности 
Ki2=0#.01 #оэффициент интегратора 
int_out2 = 34
...
for i in range(iter-1):
    ...
    #prop_out = phi_error2[i]*Kp2
    #int_out2 = phi_error2[i]*Ki2+int_out2
